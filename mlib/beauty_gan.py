...
MODEL_PATH = '../models/model_p2/model.meta'
MODEL_CHECKPOINT_PATH = '../models/model_p2'

parser = argparse.ArgumentParser()
parser.add_argument('--no_makeup', type=str, default=os.path.join('imgs', 'no_makeup', 'xfsy_0069.jpg'), help='path to the no_makeup image')
